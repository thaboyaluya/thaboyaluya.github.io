...
!function(e, t) {
      ...
      function u(e, t, n, r) {
          ...
          r.substr(0, e) + a.replace(t, n)
      }
      function s(t, Prism) {
          if (e())
              return global.Worker = require("web-worker"),
      ...
      var E, Prism = function Prism(e) {
          ...
          function l(n, r, o) {
              ...
              if (!d)
                  return !1;
              !n.name && n.matches && "string" == typeof n.matches[0] && (n.name = n.matches[0],
              delete n.matches[0]);
              var g = d[0]
                , m = d.index + o
                , b = d[0].length + m;
